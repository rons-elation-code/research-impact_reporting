...
- Spec template: `locard/protocols/spider/templates/spec.md` (includes Amendments section)
- Plan template: `locard/protocols/spider/templates/plan.md` (includes Amendment History section)
- Review template: `locard/protocols/tick/templates/review.md` (TICK-specific)
