---
# Spec Schema v2 - Feature Tracking
# Agents can ONLY change the 'status' field.
# Run `locard features --init --spec XXXX` to generate features from requirements.
spec_id: "XXXX"
title: "[Title]"
version: 2
features: []
# Example feature entry (add after running --init):
#  - id: FXXXX-001
#    description: "Feature description from requirements"
#    verification: "How to verify this feature works"
#    required_tests: ["tests/feature.test.ts"]
#    status: pending
---
...
## References
- [Link to relevant documentation in locard/resources/]
...
**Key Feedback**:
- [Model]: [Key insight or concern raised]
- [Model]: [Key insight or concern raised]
**Sections Updated**:
...
|----------|-------|---------------|------------|
| CRITICAL | [None or describe] | [How exploited] | [How addressed in spec] |
| HIGH | [None or describe] | [How exploited] | [How addressed in spec] |
| MEDIUM | [None or describe] | - | [How addressed] |

**Security Sections Updated**:
- [Section]: [How updated to address finding]

**Verdict**: [APPROVE / REQUEST_CHANGES - ALL findings resolved]

Note: All consultation and security review feedback has been incorporated directly into the relevant sections above.
