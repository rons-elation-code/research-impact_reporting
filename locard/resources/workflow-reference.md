...
Quick reference for the 7-stage project workflow. For protocol details, see `locard/protocols/spider/protocol.md`.
...
af open locard/specs/0044-name.md
...
# Import from GitHub
locard import github:locard/ansari-project

# Preview without running Claude
locard import github:owner/repo --dry-run
```
...
- Full SPIDER protocol: `locard/protocols/spider/protocol.md`
- Builder role: `locard/roles/builder.md`
- Architect role: `locard/roles/architect.md`
- Consultant role: `locard/roles/consultant.md`
